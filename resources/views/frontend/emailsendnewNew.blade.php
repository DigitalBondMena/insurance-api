                ...
                <tr>
                    <td>
                        ...
                        <table align="center" style="padding: 0 30px;" border="0" cellpadding="0" cellspacing="0">
                            ...
                            <tr>
                                <td>
                                    <h2 class="title ">New message from {{ $useName }}</h2>
                                </td>
                            </tr>
                            <tr>
                                <td>
                                    <p>New message has been recevied</p>
                                </td>
                            </tr>
                            <tr>
                        ...
                        <table class="order-detail" border="0" cellpadding="0" cellspacing="0">
                            ...
                            <tr style="position:relative;">
                                ...
                                <td colspan="3" class="email" id="email"
                                    style="line-height: 40px;text-align: right;padding-right: 44px;font-size: 13px;color: #000000;text-align:right;border-left: unset; position: relative;">
                                    
                                    <b>{{ $userEmail }}</b>
                                    <button style=" position: absolute;right: 2px; top: 50%; transform: translateY(-50%);" onclick="copyToClipboard('#email')" title="Copy email">
                            ...
                            <tr style="position:relative;">
                                ...
                                <td colspan="3" class="price" id="phone"
                                    style="
                                            line-height: 40px;text-align: right;padding-right: 44px;font-size: 13px;color: #000000;text-align:right;border-left: unset; position: relative;">
                                    <b><a href="tel:{{ $phone }}">{{ $phone }}</a>
                                    </b>
                                            <button style=" position: absolute;right: 2px; top: 50%; transform: translateY(-50%);" onclick="copyToClipboard('#phone')" title="Copy phone">
                                                <img src="https://digitalbondmena.com/frontend/digitalbondmessageemail/assets/images/email-temp/copy.png" alt="">
                                                </button>
                                    </td>
                            </tr>
                            ...
                            <td>
                                <div style="font-size:13px; margin:0; ">
                                    ...
                                    <a href="https://digitalbondmena.com/" target="_blank">
                                        <img src="https://digitalbondmena.com/frontend/digitalbondmessageemail/assets/images/logo/logo.png" style="height:30px; margin: -10px 5px; object-fit: contain;">
                                    </a>
