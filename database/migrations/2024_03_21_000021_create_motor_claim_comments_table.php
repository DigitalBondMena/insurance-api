...
class CreateMotorClaimCommentsTable extends Migration
{
    public function up()
    {
        Schema::create('motor_claim_comments', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('motor_claim_comments');
    }
} 