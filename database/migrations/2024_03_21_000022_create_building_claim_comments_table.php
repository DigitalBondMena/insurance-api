...
class CreateBuildingClaimCommentsTable extends Migration
{
    public function up()
    {
        Schema::create('building_claim_comments', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('building_claim_comments');
    }
} 