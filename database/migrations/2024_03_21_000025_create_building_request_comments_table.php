...
class CreateBuildingRequestCommentsTable extends Migration
{
    public function up()
    {
        Schema::create('building_request_comments', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('building_request_comments');
    }
} 